...
def embedding_data():
    ...
    if len(records):
        ...
        segment_text = [list_text[i:i+batch_size] for i in range(0, len(list_text), batch_size)]

        segment_embedding_text = [requests_to_openAI(segment, embedding_model) for segment in segment_text]
